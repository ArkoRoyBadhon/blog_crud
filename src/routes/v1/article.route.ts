...
router.patch("/a/update/:id", validateArticle, authorizeRoles("author", "admin"), updateArticleByIdController);
router.delete("/a/delete/:id", validateArticle, authorizeRoles("author", "admin"), deleteArticleByIdController);
